...
export const GLASS_PRESET_NAMES = Object.freeze(Object.keys(GlassPresets));
 ...
 * reports it in dev.
 */
export function resolvePreset(props) {
  const {
    preset,
    ...rest
  } = props;
